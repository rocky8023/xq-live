...
<html>
  <head>
    ...
    <script type="text/javascript" src="${base}/js/ux/main/main.js"></script>
  </head>
  <body class="easyui-layout">
 	...
 	<div  class="ui-login">
 		<div class="ui-login-info">
 			...
 			<a class="logout-btn" href="${base}/logout.shtml">退出</a>
 		</div>
 	</div>
 	</div>
	<!-- 树形菜单 -->
	<div data-options="region:'west',split:true,title:'Menu'" style="width:200px;">
		<div id="tree-box" class="easyui-accordion" data-options="fit:true,border:false">
			<#if (menuList)?? >
				...
				<div title="${item.text}">
					<#list item.children as node>
						<a class="menu-item" href="${base}${node.url}">${node.text}</a>
					</#list>
				</div>
				</#list>
			</#if>
	...
	<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
		<div class="panel-header" style="border: none;text-align: center;" >Copyright &copy; 2018 武汉匠心卓越科技 版权所有. &nbsp;&nbsp;官方网址:www.xq.com  &nbsp;&nbsp;鄂ICP备XXXXXX号</div>
	</div>
	<!-- 中间内容页面 -->
	<div data-options="region:'center'" >
		<div class="easyui-tabs" id="tab-box" data-options="fit:true,border:false">
			<div title="Welcome" style="padding:20px;overflow:hidden;"> 
				...
				<div style="margin-top:20px;">
					<h3>技术交流</h3>
					<p>  &nbsp;&nbsp;本系统由武汉匠心卓越科技开发提供,如有雷同纯属巧合.系统源码开放,仅供个人参考和技术交流。如需定制开发，可与本人联系.</p>
					<ul>
						<li>开发者：Zhang Peng</li>
						<li>开发者QQ：207446</li> 
					</ul>
				</div>
